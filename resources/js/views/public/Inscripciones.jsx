          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="mt-14 grid md:grid-cols-2 gap-12">
              ...
              <ul className="space-y-4 text-gray-700">
                ...
                <li>• Identificación oficial de padres o tutores</li>
      ...
      <section className="py-24 bg-gradient-to-b from-black to-[#111111] text-white">
        <AnimationSection>
          <div className="max-w-6xl mx-auto px-6 text-center">
            <h2 className="text-3xl font-bold">Información de Colegiaturas</h2>
            <div className="w-24 h-1 bg-yellow-400 mx-auto mt-4 rounded-full"></div>

            <p className="mt-8 text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Ofrecemos planes de pago flexibles y descuentos por pronto pago o
              inscripción anticipada. Nuestra prioridad es brindar educación de
              calidad con opciones accesibles para las familias.
            </p>

            <div className="mt-12 bg-[#1a1a1a] p-10 rounded-2xl border border-yellow-400/10 shadow-lg">
              <p className="text-2xl font-semibold text-yellow-400">
                Inscripciones Abiertas Ciclo Escolar {cicloEscolar.nombre}
              </p>
              <div className="mt-8">
                <a
        ...
        <AnimationSection>
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="mt-6 text-gray-600">
              Nuestro equipo administrativo está disponible para brindarle
              asesoría personalizada sobre el proceso de inscripción.
            </p>
