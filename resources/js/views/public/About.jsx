            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="w-full md:w-1/2 space-y-3">
                ...
                <p className="text-gray-300 leading-relaxed text-justify">
                  Institución educativa fundada en Chiautzingo, Puebla, con el
                  firme compromiso de ofrecer educación de calidad sustentada en
                  principios académicos rigurosos y en la formación integral de
                  valores humanos.
                </p>

                <p className="text-gray-300 leading-relaxed text-justify">
                  Bajo la dirección de Miss Lupita Moreno Escalante, el proyecto
                  educativo se ha fortalecido manteniendo una visión orientada
                  al servicio comunitario y al desarrollo pleno de la niñez.
                </p>

                <p className="text-gray-300 leading-relaxed text-justify">
                  Actualmente ubicados en Santa Ana Xalmimilulco, continuamos
                  consolidándonos como una institución comprometida con la
          ...
          <AnimationSection>
            <div className="grid md:grid-cols-3 gap-8 mt-20">
              <div className="bg-zinc-900 p-8 rounded-2xl shadow-xl hover:shadow-red-600/30 transition">
                ...
                <h4 className="font-bold text-xl mb-2">Excelencia Académica</h4>
                <p className="text-gray-400">
                  Metodologías sólidas que garantizan aprendizaje significativo
                  y preparación integral.
                </p>
              </div>

              <div className="bg-zinc-900 p-8 rounded-2xl shadow-xl hover:shadow-red-600/30 transition">
                <HeartHandshake className="text-yellow-400 mb-4" size={40} />
                <h4 className="font-bold text-xl mb-2">Formación en Valores</h4>
                <p className="text-gray-400">
                  Educación centrada en principios éticos y responsabilidad
                  social.
                </p>
              </div>

              <div className="bg-zinc-900 p-8 rounded-2xl shadow-xl hover:shadow-red-600/30 transition">
                <ShieldCheck className="text-yellow-400 mb-4" size={40} />
                <h4 className="font-bold text-xl mb-2">
                  Confianza y Seguridad
                </h4>
                <p className="text-gray-400">
                  Entorno seguro, supervisado y enfocado en el bienestar
                  infantil.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-10">
              <div className="bg-zinc-900/80 backdrop-blur-sm p-10 rounded-3xl border border-zinc-800 shadow-xl hover:shadow-red-600/30 transition duration-500 hover:-translate-y-2">
                ...
                <p className="text-gray-300 text-center leading-relaxed">
                  Ofrecer educación de calidad en un entorno seguro, con
                  formación académica sólida y valores que impulsen el
              ...
              <div className="bg-zinc-900/80 backdrop-blur-sm p-10 rounded-3xl border border-zinc-800 shadow-xl hover:shadow-red-600/30 transition duration-500 hover:-translate-y-2">
                <div className="flex justify-center mb-6">
                  <Lightbulb size={50} className="text-yellow-400" />
                </div>
                ...
                <p className="text-gray-300 text-center leading-relaxed">
                  Consolidarnos como una institución reconocida por excelencia
                  académica, compromiso social y formación de líderes íntegros.
                </p>
