        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          <div>
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h2 className="text-2xl font-extrabold text-yellow-400 w-full">
                  Instituto Real de México A.C.
                </h2>
                <p className="text-sm text-red-100 mt-1">
                  Escuela Primaria Particular Incorporada a la SEP
                </p>
                <p className="text-sm text-red-100">Clave: 21PPR0827N</p>
              </div>
            </div>

            <p className="mt-6 text-sm text-red-100 leading-relaxed">
              Comprometidos con la formación académica y humana de cada alumno,
              fortaleciendo valores y excelencia educativa.
            </p>
          </div>

          <div className="flex justify-center">
            <div>
              <h3 className="text-xl font-bold mb-6">Conéctate</h3>
            ...
            <div className="space-y-5 text-red-100 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p>Santa Ana Xalmimilulco, Huejotzingo, Puebla</p>
                </div>
              </div>
