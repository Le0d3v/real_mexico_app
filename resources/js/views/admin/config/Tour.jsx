...
export default function Tour({ user }) {
  const { startTour, startTutorTour } = useAdminTour();
        ...
        <div className="flex items-start gap-4">
          <div className="flex-1">
            <p className="text-gray-600 text-sm leading-relaxed">
              Inicie un recorrido interactivo que le mostrará las principales
              secciones del sistema. Durante el tour se resaltarán los elementos
              clave de la interfaz y se explicará la función de cada módulo,
              permitiéndole comprender rápidamente cómo gestionar estudiantes,
              pagos y contenido dentro de la plataforma.
            </p>

            <div className="mt-4 flex items-center gap-5">
              <button
                onClick={esAdmin ? startTour : startTutorTour}
