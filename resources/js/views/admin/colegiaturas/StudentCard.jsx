...
export default function StudentCard({ student, discard = false, onDiscard }) {
    return (
        <div className="border border-gray-200 bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition">
            {discard ? (
