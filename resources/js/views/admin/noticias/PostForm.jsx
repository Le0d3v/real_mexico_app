  ...
  const handleSubmitForm = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: "Los Cambios se han actualizado en la Base de Datos",
      });
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmitForm}>
        <div className="my-3">
          <label className="block font-semibold">Imagen (.jpg / .png)</label>
          ...
          {preview && (
            <div className="mt-2">
              <p className="text-sm text-gray-500">Imagen Previa: </p>
              <img
                src={preview}
                alt="preview"
        ...
        <div className="my-3">
          <label className="block font-semibold">Título / Encabezado</label>
          <input
            type="text"
            value={titulo}
